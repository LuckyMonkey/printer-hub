    ...
    'printers' => [
        'zebra-zp505' => [
            ...
            'batch' => [
                ...
                'recommendedBarcodeTypes' => ['CODE128', 'QR'],
                'title' => 'Batch Labels',
                'helperText' => 'Paste values to print a Zebra sheet with up to 12 labels per run.',
                'inputHint' => 'One value per line is recommended. Commas also work.',
            ],
            'capabilities' => [
        ...
        'brother-ql820' => [
            ...
            'batch' => [
                ...
                'maxValues' => 120,
                'defaultBarcodeType' => 'CODE128',
                'recommendedBarcodeTypes' => ['CODE128'],
